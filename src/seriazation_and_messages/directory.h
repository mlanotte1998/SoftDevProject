        ...
        while (ser_token != NULL) {
            ...
            if (!empty_directory) {
                ...
                if (strncmp("-p7_val::", ser_token, strlen("-p7_val::")) == 0) {
                    ...
                    while (p7_token != NULL && p7_index < ports_count_ && !end_of_p7_array &&
                           p7_token - p7_value <= p7_array_length) {
                ...
                if (strncmp("-p11_val::", ser_token, strlen("-p11_val::")) == 0) {
                    ...
                    while (p11_token != NULL && p11_index < nodes_count_ && !end_of_p11_array &&
                           p11_token - p11_value <= p11_array_length) {
                        // token starts after delimiter
                        p11_token++;
