    ...
    */
    FloatColumn(int n, ...) {
        ...
        if (n > 0) {
            ...
            binary_column_array_ = new float *[int(ceil(log2(n + 1)))];
            float *cur_array = new float[1];
            int cur_hor = 0;
            int cur_ver = 0;
    ...
    /***
     * Destructor for the FloatColumn
     */
    ~FloatColumn() {
     ...
     * @return returns the float at the index or errors.
     */
    ...
    */
    ...
    void push_back(float val) {
        ...
        if (size_ == 0) {
            ...
            float **new_binary_array = new float *[int(ceil(log2((size_ + 1) + 1)))];
            ...
            float *new_inner_array = new float[int(pow(2, array_length_ + 1))];
